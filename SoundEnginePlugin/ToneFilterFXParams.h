...
#ifndef ToneFilterFXParams_H
#define ToneFilterFXParams_H
    ...
    : public AK::IAkPluginParam
{
    ...
    ToneFilterRTPCParams RTPC;
    ToneFilterNonRTPCParams NonRTPC;
};

#endif // ToneFilterFXParams_H
