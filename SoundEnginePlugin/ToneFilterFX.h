...
private:
    ...
    std::array<std::tuple<float, float>, 48> filterParams{
        std::tuple(19.5f, 100.0f),
        std::tuple(21.8f, 100.0f),
        std::tuple(24.5f, 100.0f),
        std::tuple(27.5f, 100.0f),
        std::tuple(30.9f, 100.0f),
        std::tuple(34.7f, 100.0f),
        std::tuple(38.9f, 80.0f),
        std::tuple(49.0f, 80.0f),
        std::tuple(55.0f, 80.0f),
        std::tuple(61.7f, 80.0f),
        std::tuple(69.3f, 80.0f),
        std::tuple(77.8f, 80.0f),
        std::tuple(87.3f, 80.0f),
        std::tuple(98.0f, 80.0f),
        std::tuple(110.0f, 80.0f),
        std::tuple(123.5f, 80.0f),
        std::tuple(138.6f, 80.0f),
        std::tuple(155.6f, 80.0f),
        std::tuple(174.6f, 80.0f),
        std::tuple(196.0f, 80.0f),
        std::tuple(220.0f, 80.0f),
        std::tuple(245.0f, 80.0f),
        std::tuple(277.2f, 80.0f),
        std::tuple(311.1f, 80.0f),
        std::tuple(349.2f, 80.0f),
        std::tuple(392.0f, 60.0f),
        std::tuple(440.0f, 60.0f),
        std::tuple(493.9f, 60.0f),
        std::tuple(554.4f, 60.0f),
        std::tuple(662.3f, 40.0f),
        std::tuple(698.5f, 40.0f),
        std::tuple(784.0f, 40.0f),
        std::tuple(880.0f, 40.0f),
        std::tuple(987.8f, 40.0f),
        std::tuple(1108.7f, 40.0f),
