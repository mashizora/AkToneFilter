...
private:
    ...
    std::array<std::tuple<float, float>, 48> filterParams{
        ...
        std::tuple(440.00f, 60.f),
        std::tuple(466.16f, 60.f),
        std::tuple(493.88f, 60.f),
        std::tuple(523.25f, 60.f),
        std::tuple(554.37f, 60.f),
        std::tuple(587.33f, 60.f),
        std::tuple(622.25f, 60.f),
        std::tuple(659.25f, 60.f),
        std::tuple(698.46f, 60.f),
        std::tuple(739.99f, 60.f),
        std::tuple(783.99f, 60.f),
        std::tuple(830.61f, 60.f),
        std::tuple(880.00f, 60.f),
        std::tuple(932.33f, 60.f),
        std::tuple(987.77f, 60.f),
        std::tuple(1046.50f, 60.f),
        std::tuple(1108.73f, 60.f),
        std::tuple(1174.66f, 60.f),
        std::tuple(1244.51f, 60.f),
        std::tuple(1318.51f, 60.f),
        std::tuple(1396.91f, 60.f),
        std::tuple(1479.98f, 60.f),
        std::tuple(1567.98f, 60.f),
        std::tuple(1661.22f, 60.f),
        std::tuple(1760.00f, 60.f),
        std::tuple(1864.66f, 60.f),
        std::tuple(1975.53f, 60.f),
        std::tuple(2093.00f, 60.f),
        std::tuple(2217.46f, 60.f),
        std::tuple(2349.32f, 60.f),
        std::tuple(2489.02f, 60.f),
        std::tuple(2637.02f, 60.f),
        std::tuple(2793.83f, 60.f),
        std::tuple(2959.96f, 60.f),
        std::tuple(3135.96f, 60.f),
        std::tuple(3322.44f, 60.f),
